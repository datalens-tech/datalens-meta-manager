export {schema as gatewaySchema} from '../src/components/gateway/schema';
export {getGatewayConfig} from '../src/components/gateway';

export {initSwagger} from '../src/components/api-docs';
...
export {initTemporal} from '../src/components/temporal/utils';
